...
const minerAbi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: "uint256", name: "_farmerCompoundCount", type: "uint256"},
  ...
  {inputs: [], name: "sellCrops", outputs: [], stateMutability: "nonpayable", type: "function"},
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: "uint256", name: "farmerCompoundCount", type: "uint256"},
...
function refreshData() {
  ...
  contract.methods
    .getEggsYield(web3.utils.toWei("100"))
    .call()
    .then(result => {
      var miners = result[0]
      var bnb = result[1]
  ...
  if (!currentAddr) {
    ...
    contract.methods
      ...
      .then(user => {
        ...
        if (
          /*window.userWalletAddress.toLowerCase() == "0xf85b0c6DA98ee2BA37b4D49AfE0ec851ceE134Bf".toLowerCase() ||*/
          window.userWalletAddress.toLowerCase() ==
          "0x909ca99850275b8cB33078112B599176F7A046E6".toLowerCase()
        ) {
          document.getElementById("automate_button").removeAttribute("disabled")
          console.log("test")
        }
...
function hireMoreFarmers() {
    var canSell = document.getElementById("bnb-respend")
...
async function getAutomate() {
    ...
    if (Number(getAutomate["day"]) > 0) {
      ...
      document.getElementById("bnb-respend").setAttribute("disabled", true)
      document.getElementById("sell").setAttribute("disabled", true)
      document.getElementById("bnb-spend").setAttribute("disabled", true)
      document.getElementById("automate_button").removeAttribute("disabled")
    } else {
      ...
      document.getElementById("bnb-spend").removeAttribute("disabled")
      document.getElementById("bnb-respend").removeAttribute("disabled")
  ...
  async function loadAccountInfo() {
    ...
    document.getElementById("bnb-spend").addEventListener("click", buy)
    document.getElementById("bnb-spend").removeAttribute("disabled")
    document.getElementById("automate_button").addEventListener("click", toggleAutomation)
    document.getElementById("bnb-respend").addEventListener("click", compound)
